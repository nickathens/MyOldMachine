...
# Προσοχή: οι τιμές των 16 mm2 (66 A) και 25 mm2 (88 A) ακολουθούν τον πίνακα
# της εποχής του ΕΛΟΤ HD 384. Νεότερες εκδόσεις του IEC 60364-5-52 δίνουν
# ελαφρώς διαφορετικές τιμές. [ΕΠΑΛΗΘΕΥΣΕ] στο ισχύον κείμενο του προτύπου
# πριν από οριστική επιλογή, ή δώσε ρητή τιμή με το --iz.
IZ_B1_PVC_CU_3 = {
