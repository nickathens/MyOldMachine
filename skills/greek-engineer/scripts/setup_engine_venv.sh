...
#
# Γιατί ξεχωριστό venv: πολιτική απομόνωσης, όχι ενεργή σύγκρουση. Το PyNiteFEA
# απαιτεί numpy >= 2.4, ενώ το ταβάνι numpy του numba της βασικής εγκατάστασης
# αλλάζει με την έκδοσή του (η σειρά 0.63.x όριζε < 2.4, ασύμβατο· το 0.65.1 που
# είναι εγκατεστημένο εδώ, έλεγχος 2026-07-18, δέχεται < 2.5 και συνυπάρχει με το
# numpy 2.4.4). Οι βαριές μηχανές μένουν εκτός του κοινού venv ώστε καμιά μελλοντική
# έκδοση να μην μπορέσει να σπάσει τη φωνητική μεταγραφή. Εδώ ζει χωριστά και
